...
cp /app/superset/templates_overrides/superset/public_welcome.html /app/superset/templates/superset/
cp /app/superset/templates_overrides/head_custom_extra.html /app/superset/templates/head_custom_extra.html
