...
THEME_OVERRIDES = {
    "borderRadius": 5,
    "colors": {
        "link": DSFR_COLORS["sun"]["blue-france-sun-113-625"],
        "text": {
...
def get_description(colorname):
    cut_index = colorname.index("sun")
    colorname = colorname[:cut_index]
...
EXTRA_SEQUENTIAL_COLOR_SCHEMES = [
    {
        "id": colorname,
        "description": get_description(colorname),
        "isDiverging": True,
        "label": get_description(colorname),
        "isDefault": False,
        "colors": [
            DSFR_COLORS["sun"][colorname],
            DSFR_COLORS["sun"]["grey-950-100"], #eeeeee,
        ],
    }
    for colorname in [
